...
export function verify_and_send_form(ractive, seq, name, email, submit_url, times_url, check_states, job_list)
{
  ...
  error_message = verify_form(seq, name, email,
                              [check_states.psipred_checked, check_states.disopred_checked,
                               check_states.memsatsvm_checked, check_states.pgenthreader_checked,
                               check_states.mempack_checked, check_states.genthreader_checked,
                               check_states.dompred_checked, check_states.pdomthreader_checked,
                               check_states.bioserf_checked, check_states.domserf_checked,
                               check_states.ffpred_checked, check_states.metapsicov_checked,
                               check_states.check_states, check_states.metsite_checked,
                               check_states.hspred_checked, check_states.memembed_checked,
                               check_states.gentdb_checked]);
