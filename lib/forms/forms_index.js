...
export function verify_and_send_form(ractive, seq, name, email, submit_url, times_url, check_states, job_list, job_names, options_data)
{
  ...
  if(error_message.length > 0)
  {
    ...
    response = send_job(ractive, job_string, seq, name, email, submit_url, times_url, job_names, options_data);
