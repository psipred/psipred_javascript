...
export function verify_and_send_form(ractive, seq, name, email, submit_url, times_url, psipred_checked,
                              disopred_checked, memsatsvm_checked, pgenthreader_checked, mempack_checked, genthreader_checked, dompred_checked,
                              pdomthreader_checked, bioserf_checked, domserf_checked, ffpred_checked, metapsicov_checked,
                              metasite_checked, hspred_checked, memembed_checked, gentdb_checked)
{
