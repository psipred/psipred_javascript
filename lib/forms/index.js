import { send_job } from '../common/index.js';
import { isInArray } from '../common/index.js';
                              ...
                              ractive_instance)
{
  ...
  if(error_message.length > 0)
  {
    ...
    response = send_job(ractive, job_string, seq, name, email, ractive_instance, submit_url, times_url);
