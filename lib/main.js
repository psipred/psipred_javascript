...
console.log("Working out where I am");
...
ractive.on('submit', function(event) {
  ...
  if(email.length === 0)
  {
    var r = confirm("No email address was provided.\nAnalyses can be long running and we recommend users leave an email address to revieve completion alerts\nPress OK to submit anyway");
    if(r == true)
    {
