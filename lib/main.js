...
ractive.on('submit', function(event) {
  ...
  options_data.bioserf_modeller_key = document.getElementById("bioserf_modeller_key");
  options_data.domserf_modeller_key = document.getElementById("domserf_modeller_key");
  options_data.ffpred_type = document.getElementById("ffpred_selection");
  options_data.metsite_checkchains_chain = document.getElementById("metsite_chain_id");
  options_data.extract_fasta_chain = document.getElementById("metsite_chain_id");
  options_data.seedSiteFind_metal = document.getElementById("metsite_metal_type");
  options_data.seedSiteFind_chain = document.getElementById("metsite_chain_id");
  options_data.metpred_wrapper_chain = document.getElementById("metsite_chain_id");
  options_data.metpred_wrapper_metal = document.getElementById("metsite_metal_type");
  options_data.metpred_wrapper_fpr = document.getElementById("metsite_fpr");
  options_data.hspred_checkchains_chains = document.getElementById("hspred_protein_1")+document.getElementById("hspred_protein_2");
  options_data.hs_pred_first_chain = document.getElementById("hspred_protein_1");
  options_data.hs_pred_second_chain = document.getElementById("hspred_protein_2");
  options_data.split_pdb_files_first_chain =  document.getElementById("hspred_protein_1");
  options_data.split_pdb_files_second_chain = document.getElementById("hspred_protein_2");
  ...
  // let pass_modeller = handle_modeller_key(options_data.bioserf_modeller_key);
  // pass_modeller = handle_modeller_key(options_data.domserf_modeller_key);
  // select ffpred name/type
...
ractive.on('resubmit', function(event) {
  ...
  options_data.bioserf_modeller_key = null;
  options_data.domserf_modeller_key = null;
  options_data.ffpred_type = "human";
  options_data.metsite_checkchains_chain = null;
  options_data.extract_fasta_chain =null;
  options_data.seedSiteFind_metal = null;
  options_data.seedSiteFind_chain = null;
  options_data.metpred_wrapper_chain = null;
  options_data.metpred_wrapper_metal = null;
  options_data.metpred_wrapper_fpr = null;
  options_data.hspred_checkchains_chains = null;
  options_data.hs_pred_first_chain = null;
  options_data.hs_pred_second_chain = null;
  options_data.split_pdb_files_first_chain = null;

  verify_and_send_form(ractive, subsequence, name, email, submit_url, times_url, check_states, job_list, job_names);
...
export function swapDomserf(uri_number)
{
  ...
  let paths = ractive.get("domserf_model_uris");
  display_structure(paths[uri_number], '#domserf_model');
}
