...
let job_list = ["psipred", "disopred", "memsatsvm", "pgenthreader", "mempack",
                "genthreader", "dompred", "pdomthreader", "bioserf", "domserf",
                "ffpred", "metapsicov", "metsite", "hspred", "memembed", "gentdb"];
let job_names = {
...
ractive.on('resubmit', function(event) {
  ...
  clear_settings(ractive, gear_string, job_list);
