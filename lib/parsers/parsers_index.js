export function parse_hspred(ractive, file)
{
  ...
  hspred_table += '<table id="hspred_table" class="table table-striped table-bordered"><thead><tr><th>Chain/Residue</th><th>Residue Identity</th><th>Score</th></thead><tbody>';
...
export function parse_metsite(ractive, file)
{
  ...
  metsite_table += '<table id="metsite_table" class="table small-table table-striped table-bordered"><thead><tr><th>Residue Number</th><th>Raw Neural Network Score</th><th>Residue</th><thead><tbody>';
